export function PlaneIllustration(props) {
  return (
    <svg
      viewBox="0 0 220 130"
      width="100%"
      ...
      role="img"
      aria-label="Cargo plane in flight"
      {...props}
    >
      <defs>
        <linearGradient id="planeSky" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="#eaf6f0" />
          <stop offset="100%" stopColor="#cfe9db" />
        </linearGradient>
      </defs>
      <rect width="220" height="130" fill="url(#planeSky)" />
      {/* contrail */}
      <path d="M0,86 Q30,78 62,72" fill="none" stroke="#01a159" strokeOpacity="0.25" strokeWidth="3" strokeLinecap="round" />
      {/* tail wing */}
...
export function ShipIllustration(props) {
  return (
    <svg
      viewBox="0 0 220 130"
      width="100%"
      ...
      preserveAspectRatio="xMidYMid slice"
      role="img"
      aria-label="Cargo ship at sea"
      {...props}
    >
      <defs>
        <linearGradient id="shipSea" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="#ecf0f9" />
          <stop offset="100%" stopColor="#d3ddf3" />
        </linearGradient>
      </defs>
      <rect width="220" height="130" fill="url(#shipSea)" />
      {/* water */}
      <path
